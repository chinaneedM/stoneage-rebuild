...
1. **Resolve Combo + DamageReact ultimate side effects only to the literal pinned-source behavior.** Preserve the discarded immediate `BATTLE_DamageSub` return and final `DamageSub2`/Reflect target-order quirk rather than normalizing it.
