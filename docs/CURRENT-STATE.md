...
1. Continue **zero-cost public-source StoneAge package research**: the direct retail JAN is now resolved as **`4909476303010`** from preserved Yahoo! package photography; continue trying to recover the 13 Mercari original-image bodies and other higher-resolution public side/back/disc images for the still-missing model/type code, disc labels and matrix text. Do not pursue purchase, bidding, seller contact, shipping, or user-side acquisition.
