...
- Preserved a catalog-price conflict rather than flattening it: Suruga currently displays **9,680円**, while contemporaneous/first-party launch evidence records **8,800円** (including 8,800円 before tax in the period advertisement). The modern retailer field does not supersede the period record.
