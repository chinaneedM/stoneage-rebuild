...
3. **Recover the independently attested Korean retail/package game CD.** Contemporary evidence now reaches **2000-10-27**, when Inium reportedly contracted roughly **60,000 sale packages** through Mentec and Yongsan PC-game distribution; 2001 reporting independently confirms a purchasable game CD with a two-month coupon and package purchasers. Search public preservation catalogs, disc-dump communities, checksum databases, package/disc photographs and old software-CD indexes; keep it distinct from the GameTime guide bonus CD until media-level evidence proves equality.
