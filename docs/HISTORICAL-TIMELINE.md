...
**RESEARCH CONSEQUENCE:** the newly recovered 2000-12-20 `samap_1220.zip` record is chronologically earlier, but its currently known Sina/Wayback route is bounded without bytes. The 2001 full-map package is therefore the **active next recovery target**, ahead of the 2002-11-08 4.0 package. If recovered, its DAT corpus must be compared directly against Taiwan v1.0, the 2000 package if later recovered, June-2003 and mixed-2.5 states before any historical equivalence is asserted.
