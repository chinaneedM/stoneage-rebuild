#!/usr/bin/env python3
"""Independent archive metadata probe for Sina's 2001-11-27 StoneAge full-map token.
...
SOURCE="http://games.sina.com.cn/downgames/map/11271899.shtml"
CGI="http://games1.sina.com.cn/cgi-bin/games/downgames/download.pl?col=map&aid=43172&title=%A1%B6%CA%AF%C6%F7%CA%B1%B4%FA%A1%B7%C8%AB%B5%D8%CD%BC&author=%D3%CE%C3%F1%B2%BF%C2%E4%CD%F8%D3%D1%3Ca%20href%3D%22http%3A%2F%2Fwww.xinhaonanhai.com%22%3Exinhaonanhai%3C%2Fa%3E%CC%E1%B9%A9&filename=Estoneage2.0map_1127.exe&size=1911"
...
def main():
    ...
    if arq_rows or cc_rows:
        print("RESOLUTION|INDEPENDENT_ARCHIVE_ROWS_FOUND|inspect exact filename/URL matches before any payload recovery")
    else:
        print("RESOLUTION|NO_INDEPENDENT_ARCHIVE_ROW|tested independent public archive indexes expose no indexed target row")
